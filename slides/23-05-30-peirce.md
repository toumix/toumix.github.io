...
- The blank page, representing truth $G = \top$
...
This inductive definition can equivalently be given geometrically as:
...
Defining trees with nested circles should be familiar:
...
Now we can do all of Boolean algebra with diagrams!
...
<style scoped> section table *, section table tbody>tr:nth-child(odd) td { background-color: white; border-width: 0; } section table { width: 1000px; height: 300px; }</style>

|   |   |
|---|---|
| ![](https://plato.stanford.edu/entries/peirce-logic/Atom.svg) | ![](https://plato.stanford.edu/entries/peirce-logic/Love.svg) |

These are called **lines of identity**.
...
Lines of identity correspond to **Frobenius algebras**, also called **spiders**.
...
- Semantics as monoidal functors into $\mathbf{Rel}$ or $\mathbf{Span}$.
